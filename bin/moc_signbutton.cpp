/****************************************************************************
** Meta object code from reading C++ file 'signbutton.h'
**
...
#include "../../Source/signbutton.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'signbutton.h' doesn't include <QObject>."
...
void signbutton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        signbutton *_t = static_cast<signbutton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->cal(); break;
        default: ;
...
const QMetaObject signbutton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_signbutton.data,
      qt_meta_data_signbutton,  qt_static_metacall, nullptr, nullptr}
};
...
void *signbutton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_signbutton.stringdata0))
        return static_cast<void*>(const_cast< signbutton*>(this));
